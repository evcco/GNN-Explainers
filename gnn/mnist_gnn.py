...
#         data.x = Variable(data.x, requires_grad=True)
#         data.edge_attr = Variable(data.edge_attr, requires_grad=True)
...
if __name__ == '__main__':
    ...
    torch.save(model, osp.join(args.model_path, 'mnist_net.pt'))
