...
class TR3Motif(InMemoryDataset):
    ...
    def download(self):
        if not osp.exists(osp.join(self.raw_dir, 'raw', 'TR-3motif.npy')):
            print("raw data of `TR-3motif.npy` doesn't exist, please redownload from our github.")
...
# Epoch  99[2.433s]: LR: 0.00134, Loss: 0.01201, Train acc: 0.99455, Validation Loss: 0.03519, Validation acc: 0.992500
# Epoch 100[2.694s]: LR: 0.00134, Loss: 0.01455, Test Loss: 0.04341, Test acc: 0.99000