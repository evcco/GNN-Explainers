...
class Screener(Explainer):
    ...
    def __init__(self, gnn_model_path, gen_model_path=None):
        super(Screener, self).__init__(gnn_model_path, gen_model_path)
    ...
    def explain_graph(self, graph,
        ...
        # initial_score = np.random.randn(graph.num_edges) + 10
